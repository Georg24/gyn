                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 input-group col-xs-4">
                            <input id="inputbuscar" name="modelo" type="text" placeholder="ej: HBS500" class="form-control input-md" maxlength="49" autofocus autocomplete="off">
...
<script>
    ...
    function inicio()
    {
        ...
        //====para buscar un productos y llenar la tabla al cambiar el input====
                ...
                $.ajax({
                    ...
                    success: function (resp) {
                        ...
                        for (var i = 0; i < reg.length; i++)
                        {
                            ...
                            html = html + "<div class='media'><div class='media-left'><img class='accional2' src='<?php echo base_url() . 'sources/ups/'; ?>" + reg[i]['imagen'] + "' style='width: 240px; height: 265px;' hidden>"
                                    + "<img class='media-object img-rounded'"
                                    + "src='<?php echo base_url() . 'sources/ups/'; ?>" + reg[i]['imagen'] + "' style='width: 140px; height: 140px;'>"
                            ...
                            if (reg[i]['existencia'] > 0)
                            {
                                html = html + "<h3 class='col-lg-12 col-md-6 col-sm-6 col-xs-6 cant'><span class='label label-primary badge-md'>" + reg[i]['existencia'] + "</span></h3>"
                                        + "<input type='submit' class='btn btn-success btn-md' id='btnadd' value='Agregar' style='height: 2.5em;width: 7em; font-size: 100%'>";
                            } else {
...
<?php //} ?>
        ...
        //});
        //===========================================================
        //AUTOCOMPLETAR para los clientes de la venta
        $(function () {
            var autocompletar = new Array();
<?php
//helper de venta_helper .. 
